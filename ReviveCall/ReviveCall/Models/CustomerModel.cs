...
namespace ReviveCall.Models
{
    public class CustomerModel
    {
        ...
        {
            using (ReviveEntities entities = new ReviveEntities())
            {
        ...
        public CustomerModel(WorkOrder workOrder, ReviveEntities FarmerBrothersEntitites)
        {
        ...
        public void CreateUnknownCustomer(CustomerModel CustModel, ReviveEntities FBE)
        {
        ...
        public static int GetCallsTotalCount(ReviveEntities FBE, string CustomerID)
        {
        ...
        public static string GetServiceLevelDesc(ReviveEntities FBE, string BillingCode)
        {
            string Description = "";
        ...
        public static void InsertCustomerData(List<CustomerModel> customerList, ReviveEntities fileUploadEntity)
        {
