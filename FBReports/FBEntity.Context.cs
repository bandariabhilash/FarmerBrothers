...
namespace FBReports
{
    ...
    public partial class FB_Entities : DbContext
    {
        public FB_Entities()
            : base("name=FB_Entities")
        {
        }
        ...
        public virtual int USP_SuperInvoice_ReportDetails(string startDate, string endDate, Nullable<int> pricingParentID, string familyAff, Nullable<int> techID, string eSM)
        {
            var startDateParameter = startDate != null ?
                new ObjectParameter("StartDate", startDate) :
                new ObjectParameter("StartDate", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_SuperInvoice_ReportDetails", startDateParameter, endDateParameter, pricingParentIDParameter, familyAffParameter, techIDParameter, eSMParameter);
        }
