<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DefaultTuch.aspx.cs" Inherits="DefaultTuch" %>
    ...
    $(function () {
        $("[id$=txtSearch]").autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/DefaultTuch.aspx/GetParts") %>',
        ...
        $('#search').click(function () {
            ...
            //alert(sid);
            $.ajax({
                url: '<%=ResolveUrl("~/DefaultTuch.aspx/GetItems") %>',
                data: "{ 'SID': '" + sid + "'}",
                dataType: "json",
                type: "POST",
                contentType: "application/json; charset=utf-8",
        ...
        $('#Button2').click(function () {
            if ($('#CallType').val() != '0' || $('#CompletionCode').val() != '0' || $('#EquipType').val() != '0' || $('#Vendor').val() != '0' || $('#model').val() != '' || $('#serial').val() != '') {
...
                                        <canvas style="margin-top: -25px; background-color: #e6e4e4; width: 300px; height: 152px;"></canvas>
                                    </div>
