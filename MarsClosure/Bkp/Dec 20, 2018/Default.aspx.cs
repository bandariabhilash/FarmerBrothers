...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd2 = new SqlCommand("INSERT INTO TMP_BlackBerry_SCFInvoiceInfo(WorkorderID, TechID, StartDateTime, ArrivalDateTime, CompletionDateTime,SignedBy,InvoiceNo) values('" + Eventid + "', '" + Techid + "', '" + Sdate.ToString("yyyy-MM-dd HH:mm:ss") + "', '" + Adate.ToString("yyyy-MM-dd HH:mm:ss") + "', '" + Cdate.ToString("yyyy-MM-dd HH:mm:ss") + "','" + SignedBy1 + "','" + InvNo1 + "')", con);
