...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("INSERT INTO TMP_BlackBerry_SCFAssetInfo(WorkorderID, TechID, ServiceCode, SymptomCode, SystemCode, CompletionCode, EquipTypeCode, VendorCode, Model, SerialNo, Notes, CloseCall, ClosureConfirmationNo, Weight, Ratio, Temperature) values ('" + Eventid + "', '" + Techid + "', '" + CallType1 + "', '" + SymptomCode1 + "', '" + SystemCode1 + "', '" + CompletionCode1 + "', '" + EquipType1 + "', '" + Vendor1 + "', '" + model1 + "', '" + serial1 + "', '" + EventNotes1 + "',0, '" + sNewPass + "', '" + weight + "','"+ratio+"','"+temp+"')", con);
