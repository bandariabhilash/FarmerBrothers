...
namespace NewcoCall.Models
{
    public class CustomerServiceModel
    {
        ...
        public CustomerServiceModel(Contact contact)
        {
            ...
            this.ParentId = string.IsNullOrEmpty(contact.PricingParentID) ? 0 : Convert.ToInt32(contact.PricingParentID);
        }

        public bool IsExistingCustomer { get; set; }
        public int AccountNumber { get; set; }
        [Required(ErrorMessage = "NewcoCustomerNumber Required")]
