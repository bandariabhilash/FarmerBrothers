...
namespace FBCall.Models
{
    public class WorkOrderManagementEquipmentModel
    {
        ...
        public WorkOrderManagementEquipmentModel(WorkorderEquipment workOrderEquipment, FBWWOCallEntities FormalBrothersEntities)
        {
        ...
        public WorkOrderManagementEquipmentModel(WorkorderEquipmentRequested workOrderEquipment, FBWWOCallEntities MarsServiceEntities)
        {
            Manufacturer = workOrderEquipment.Manufacturer;
            Solution = workOrderEquipment.Solutionid;
            Temperature = workOrderEquipment.Temperature;
