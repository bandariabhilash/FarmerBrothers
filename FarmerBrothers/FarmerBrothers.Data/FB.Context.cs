...
namespace FarmerBrothers.Data
{
    ...
    public partial class FarmerBrothersEntities : DbContext
    {
        ...
        public virtual DbSet<ERFUploadDataDec272024> ERFUploadDataDec272024 { get; set; }
        ...
        public virtual int USP_SuperInvoice_Report_OLD(string startDate, string endDate, Nullable<int> pricingParentID, string familyAff, Nullable<int> techID)
        {
            var startDateParameter = startDate != null ?
                new ObjectParameter("StartDate", startDate) :
                new ObjectParameter("StartDate", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_SuperInvoice_Report_OLD", startDateParameter, endDateParameter, pricingParentIDParameter, familyAffParameter, techIDParameter);
        }
    
        public virtual int USP_SuperInvoice_ReportDetails_OLD(string startDate, string endDate, Nullable<int> pricingParentID, string familyAff, Nullable<int> techID, string eSM, string route)
        {
            var startDateParameter = startDate != null ?
                new ObjectParameter("StartDate", startDate) :
                new ObjectParameter("StartDate", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_SuperInvoice_ReportDetails_OLD", startDateParameter, endDateParameter, pricingParentIDParameter, familyAffParameter, techIDParameter, eSMParameter, routeParameter);
        }
    }
}
