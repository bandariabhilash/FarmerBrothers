...
namespace FarmerBrothers.Models
{
    ...
    public class WorkorderNSRCloseModel : BaseModel
    {
        public string WorkOrderId { get; set; }
        public bool IsCustomerServiceEvent { get; set; }
    }
    public class WorkorderNSRCloseResultModel : BaseModel
    {
        public int WorkOrderId { get; set; }
    ...
    public class NonFBParentReportModel
    {
        public DateTime? DateFrom { get; set; }
        public DateTime? DateTo { get; set; }
        public string ParentId { get; set; }
        public IList<NonFBCustomer> ParentList { get; set; }

        public IList<NonFBParentReportResultModel> SearchResults;
    }
