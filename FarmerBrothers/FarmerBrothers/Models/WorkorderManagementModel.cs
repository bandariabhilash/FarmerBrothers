...
namespace FarmerBrothers.Models
{
    ...
    public class WorkorderManagementModel
    {
        ...
        public bool? isCustomerPoRequired { get; set; }
        ...
        public static IEnumerable<TechHierarchyView> GetCompleteTechData(FarmerBrothersEntities FarmerBrothersEntities)
        {
            ...
            query = @"select d.DealerId AS TechID, d.CompanyName AS PreferredProvider from TECH_HIERARCHY d where searchType='SP'  
                    ...
                    8888918,8888941,8888942,8888945,8888953,9999999,8888897,9999995,9999998,8888980,8888981,8888984,9990061,9990062) group by CompanyName, DealerId order by PreferredProvider asc";
