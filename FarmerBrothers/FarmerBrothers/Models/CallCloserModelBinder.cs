...
namespace FarmerBrothers.Models
{
    public class CallCloserModelBinder : IModelBinder
    {
                                ...
                                ModelBindingContext bindingContext)
        {
            ...
            if (!string.IsNullOrWhiteSpace(request.Unvalidated.Form.Get("Customer.CustomerId")))
            {
                model.Customer.CustomerId = request.Unvalidated.Form.Get("Customer.CustomerId");
            }
            ...
            model.SalesNotificationCode = request.Unvalidated.Form.Get("SalesNotificationCodeHidden");
            model.SalesNotificationNotes = request.Unvalidated.Form.Get("SalesNotificationNotesHidden");
            model.IsNewPartsOrder = Convert.ToBoolean(request.Unvalidated.Form.Get("IsNewPartsOrder"));
            model.OverTimeRequestDescription = request.Unvalidated.Form.Get("OverTimeRequestDescriptionHidden");
