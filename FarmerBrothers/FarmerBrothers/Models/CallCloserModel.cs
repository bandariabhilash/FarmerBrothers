...
namespace FarmerBrothers.Models
{
    public class CallCloserModel
    {
        ...
        public CallCloserModel(WorkorderSchedule workOrderSchedule, FarmerBrothersEntities FarmerBrothersEntitites)
        {
            ...
            this.CallPriority = (from w in FarmerBrothersEntitites.WorkOrders
                                 join p in FarmerBrothersEntitites.AllFBStatus on w.PriorityCode equals p.FBStatusID
                                 where w.WorkorderID == this.WorkOrderId && p.StatusFor.ToLower() == "priority"
                                 select p.FBStatus).FirstOrDefault();
            ...
            this.ThirdPartyPO = workOrderSchedule.WorkOrder.ThirdPartyPO == null ? null : workOrderSchedule.WorkOrder.ThirdPartyPO.ToString();
