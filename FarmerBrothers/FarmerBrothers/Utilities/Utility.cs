...
namespace FarmerBrothers.Utilities
{
    public class Utility
    {
        ...
        public static NonFBCustomer GetNonFBCustomer(string name, FarmerBrothersEntities FarmerBrothersEntitites)
        {
            NonFBCustomer nonFBCustomer = FarmerBrothersEntitites.NonFBCustomers.Where(n => n.NonFBCustomerName.ToLower() == name.ToLower()).FirstOrDefault();

            return nonFBCustomer;
        }
        ...
        {
            var CustomerNotes = FarmerBrothersEntities.FBCustomerNotes.Where(c => ClientId != 0 && c.CustomerId == ClientId && c.IsActive == true).ToList();
